    ...
    <main class="form-signin">
        <form method="POST" action="<?= base_url('auth/proses_register'); ?>">
            ...
            <div class="form-floating">
                <input type="text" class="form-control mb-1" name="nama" id="floatingInput" placeholder="name@example.com">
                <label for="floatingInput">Nama Lengkap</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control mb-1" name="username" id="floatingInput" placeholder="name@example.com">
                <label for="floatingInput">Username</label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control mb-1" name="password1" id="floatingPassword" placeholder="Password">
            ...
            <a href="<?= base_url('auth/login'); ?>">Sudah memiliki akun? silahkan login.</a>
