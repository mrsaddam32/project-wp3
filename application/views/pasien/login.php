...
<body class="text-center">
    <main class="form-signin">
        ...
        <form method="POST" action="<?= base_url('pasien/proses_login'); ?>">
            ...
            <div class="form-floating">
                <input type="number" class="form-control" name="no_pendaftaran" id="floatingInput" placeholder="" required autofocus>
            ...
            <a href="<?= base_url('pasien/register'); ?>">Belum memiliki akun ? silahkan register</a>
