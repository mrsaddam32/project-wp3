...
<body class="text-center">
    <main class="form-signin">
        <form method="POST" action="<?= base_url('pasien/proses_register'); ?>">
            ...
            <div class="form-floating">
                <input type="text" class="form-control mb-1" name="nama" id="floatingInput" placeholder="">
                <label for="floatingInput">Nama Lengkap</label>
            </div>
            <div class="form-floating">
                <input type="date" class="form-control mb-1" name="tgl_lahir" id="floatingInput" placeholder="">
                <label for="floatingInput">Tanggal Lahir</label>
            </div>
            <div class="form-floating">
                <input type="number" class="form-control mb-1" name="umur" id="floatingInput" placeholder="">
                <label for="floatingInput">Umur</label>
            </div>
            <div class="form-floating">
                <input type="text" class="form-control mb-1" name="keluhan" id="floatingInput" placeholder="">
            ...
            <a href="<?= base_url('pasien/login'); ?>">Sudah memiliki akun? silahkan login.</a>
